...
import { IconResumes, IconTemplates, IconSettings, IconAI, IconAIOptimize } from "@/components/shared/icons/SidebarIcons";
...
const DashboardLayout = ({ children }: { children: React.ReactNode }) => {
  ...
  const sidebarItems: MenuItem[] = [
    ...
    {
      title: t("sidebar.aiOptimize"),
      url: "/app/dashboard/ai-optimize",
      icon: IconAIOptimize,
    },
    {

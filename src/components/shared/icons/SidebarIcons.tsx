...
// AI Optimize: Target with Sparkle (Flat Gradient Purple/Pink)
export const IconAIOptimize: React.FC<IconProps> = ({ size = 24, className, active }) => (
  <svg width={size} height={size} viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    {/* Target Background - Gradient Purple to Pink */}
    <defs>
      <linearGradient id="aiOptimizeGradient" x1="4" y1="4" x2="36" y2="36">
        <stop offset="0%" stopColor="#9333EA" />
        <stop offset="100%" stopColor="#EC4899" />
      </linearGradient>
    </defs>
    <rect x="4" y="4" width="32" height="32" rx="6" fill="url(#aiOptimizeGradient)" />
    ...
    {/* Sparkle Accent */}
    <path d="M30 8L31.5 11L34.5 12.5L31.5 14L30 17L28.5 14L25.5 12.5L28.5 11L30 8Z" fill="white" fillOpacity="0.9" />
